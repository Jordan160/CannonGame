...
public class CannonView extends SurfaceView
   ...
   public static final int WALL_HIT_SOUND_ID = 3;
   ...
   public CannonView(Context context, AttributeSet attrs) {
      ...
      soundMap.put(BLOCKER_SOUND_ID,
       ...
       soundMap.put(WALL_HIT_SOUND_ID,
   ...
   private void updatePositions(double elapsedTimeMS) {
      ...
      blocker.update(interval, WALL_HIT_SOUND_ID); // update the blocker's position
   ...
   public void testForCollisions() {
      ...
      if (cannon.getCannonball() != null &&
         ...
         blocker.playSound(); // play Blocker hit sound
          //increase the blocker size by 5% on collision
          blocker.shape.bottom = (int) (blocker.shape.bottom * 1.05);
          blocker.shape.top = (int) (blocker.shape.top * 1.05);
