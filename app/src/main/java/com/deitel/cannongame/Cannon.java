...
public class Cannon {
   ...
   private Point aimLineEnd = new Point(); // endpoint of Cannon's aim line
   ...
   private Paint aimLinePaint = new Paint(); // Paint used to draw the cannon's aim line
   ...
   public void align(double barrelAngle) {
      ...
      aimLineEnd.x = (int) (view.getScreenHeight() * Math.sin(barrelAngle));
      aimLineEnd.y = (int) (-view.getScreenHeight() * Math.cos(barrelAngle)) +
              view.getScreenHeight() / 2;
   }
